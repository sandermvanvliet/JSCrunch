//------------------------------------------------------------------------------
// <copyright file="ProcessingQueue.cs" company="Microsoft">
...
namespace JSCrunch.VisualStudio
{
    ...
    public class ProcessingQueue : ToolWindowPane
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessingQueue"/> class.
        /// </summary>
        public ProcessingQueue() : base(null)
        {
            this.Caption = "ProcessingQueue";
