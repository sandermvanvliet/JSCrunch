...
namespace JSCrunch.VisualStudio.Tests.Doubles
{
    ...
    {
        private IEnumerable<IVsProject> _projects;
        ...
        public int CreateProject(ref Guid rguidProjectType, string lpszMoniker, string lpszLocation, string lpszName,
            uint grfCreateFlags, ref Guid iidProject, out IntPtr ppProject)
        {
        ...
        public int GetProjectFactory(uint dwReserved, Guid[] pguidProjectType, string pszMkProject,
        ...
        public int QueryRenameProject(IVsProject pProject, string pszMkOldName, string pszMkNewName, uint dwReserved,
        ...
        public VsSolutionDouble WithProjects(IEnumerable<IVsProject> projects)
        {
            _projects = projects;
